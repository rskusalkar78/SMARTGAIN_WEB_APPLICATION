  ...
  updateProfile: async (data: UpdateProfileData): Promise<User> => {
    ...
    if (isGuestMode) {
      ...
      if (planDataStr) {
         ...
         if (data.preferences?.age !== undefined) planData.userData.age = data.preferences.age;
         if (data.preferences?.height !== undefined) planData.userData.height = data.preferences.height;
