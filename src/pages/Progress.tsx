              ...
              <div className="flex justify-between mt-4">
                {weeklyStats.map((day, i) => (
                  <div key={i} className="flex flex-col items-center gap-1">
                    <span className="text-[10px] text-muted-foreground font-medium flex flex-col items-center">
                      <span>{day.name}</span>
                      <span className="text-[9px] opacity-70">{format(addDays(weekStart, i), 'd')}</span>
                    </span>
